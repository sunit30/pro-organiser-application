...
const MyBoard = () => {
  ...
  let getColumnName = () => {
    axios
      .get(
        `https://pro-organiser1.firebaseio.com/BoardData/${boardId}/board_column/.json`
      )
      .then((response) => {
  ...
  let HandleColumnDelete = (columnId) => {
    axios
      .delete(
        `https://pro-organiser1.firebaseio.com/BoardData/${boardId}/board_column/${columnId}/.json`
      )
    ...
    swal({
      ...
      if (willDelete) {
        return (
          axios
            .delete(
              `https://pro-organiser1.firebaseio.com/BoardData/${boardId}/.json`
            )
            .then((response) => {
              reDirectToHome();
            }),
