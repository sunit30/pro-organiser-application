...
const Board_Column = ({
  ...
  let handleDragDrop = (e) => {
    ...
    axios
      .delete(
        `https://pro-organiser1.firebaseio.com/BoardData/${boardId}/board_column/${draggingFromColumnId}/card/${draggingFromCardId}/.json`
      )
    ...
    axios
      .post(
        `https://pro-organiser1.firebaseio.com/BoardData/${boardId}/board_column/${columnId}/card/.json`,
        {
